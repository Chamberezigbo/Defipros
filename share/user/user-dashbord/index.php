...
<div class="content-inner w-100">
                         ...
                         <div class="row gx-5 bg-white">
                              ...
                              <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                                   <div class="d-flex align-items-center">
                                        ...
                                        <div class="mx-3">
                                             <h6 class="h4 fw-light text-gray-600 mb-3">Deposit Wallet Balance</h6>
                                        </div>
                              ...
                              <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                                   <div class="d-flex align-items-center">
                                        ...
                                        <div class="mx-3">
                                             <h6 class="h4 fw-light text-gray-600 mb-3">Interest Wallet<br> Balance</h6>
                                        </div>
                                        <div class="number"><strong class="text-lg">$ <?= $totalProfit ?></strong></div>
                                   </div>
                              </div>
                              <!-- Item -->
                              <div class="col-xl-3 col-sm-6 py-4 border-lg-end border-gray-200">
                                   <div class="d-flex align-items-center">
                                        ...
                                        <div class="mx-3">
                                             <h6 class="h4 fw-light text-gray-600 mb-3">Total <br>Invest</h6>
                                        </div>
                                        <div class="number"><strong class="text-lg">$ <?= $totalInvestment ?></strong></div>
                                   </div>
                              </div>
                              <!-- Item -->
                              <div class="col-xl-3 col-sm-6 py-4">
                                   <div class="d-flex align-items-center">
                                        ...
                                        <div class="mx-3">
                                             <h6 class="h4 fw-light text-gray-600 mb-3">Referral<br>Earnings</h6>
                                        </div>
                         ...
                         <!-- <div class="card mb-3">
                              <div class="card-body">
                                   <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3"><strong class="text-lg d-block lh-1 mb-1">$ <?= $totalProfit ?></strong><small class="text-uppercase text-gray-500 small d-block lh-1">Total Active Investment Plans</small></div>
                                   </div>
                              </div>
                         </div>
                         <div class="card mb-0">
                         ...
                         <div class="card mb-0">
                              <div class="card-body">
                                   <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3"><strong class="text-lg mb-0 d-block lh-1">$ <?= $totalWithdraws ?></strong><small class="text-gray-500 small text-uppercase">Total Withdraw</small></div>
                                   </div>
                              </div>
                         </div>
                    </div>
     ...
     ?>
     <!--script for kyc submits  -->
     <script>
          document.addEventListener('DOMContentLoaded', () => {
               $('#kyc_submitting').on('submit', (e) => {
